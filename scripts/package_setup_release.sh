...
#
# Writes: dist/legacy-of-kain-soul-reaver-recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix legacy-of-kain-soul-reaver-recomp \
  --exe-name Legacy_of_Kain__Soul_Reaver_Recompiled \
  --display-name "Legacy of Kain: Soul Reaver Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Legacy of Kain: Soul Reaver disc" \
