# Legacy of Kain: Soul Reaver feasibility binding

## Identity

- Title and region: Legacy of Kain: Soul Reaver, Europe.
- Serial: SLES-01301.
- Source executable path: `disc/SLES_013.01`.
- Load address: `0x80010000`.
- Entry point: `0x800B72D0`.
- Source disc binding: `disc/Legacy of Kain - Soul Reaver (Europe).cue`.
...
The clean source commit is `4d2c07cdb71ec6548deaa4dd116eb504e27b2169`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 2152 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `4d2c07cdb71ec6548deaa4dd116eb504e27b2169`.
- Portfolio `legacy-of-kain-soul-reaver/BUILDINFO.json`.
- Portfolio `legacy-of-kain-soul-reaver/RECEIPT.md`.
