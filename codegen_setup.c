...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Legacy of Kain Soul Reaver",
    .project_root_env = "LEGACY_OF_KAIN_SOUL_REAVER_RECOMP_PROJECT_ROOT",
    .build_dir_env = "LEGACY_OF_KAIN_SOUL_REAVER_RECOMP_BUILD_DIR",
    .force_setup_env = "LEGACY_OF_KAIN_SOUL_REAVER_RECOMP_FORCE_SETUP",
